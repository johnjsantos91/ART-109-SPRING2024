...
function animate() {
    ...
    ball.position.x = Math.sin(Date.now() / 2000) * 4;
    ball.position.y = Math.sin(Date.now() / 4000) * 4;
    ball.position.z = Math.sin(Date.now() / 6000) * 4;

    //ball2
    ball2.rotation.x += 0.003;
    ball2.rotation.y += 0.003;
    
    ball2.position.x = Math.sin(Date.now() / 1100) * 6;
    ball2.position.y = Math.sin(Date.now() / 6100) * 8;
    ball2.position.z = Math.sin(Date.now() / 2100) * 8;

    //ball3
    ball3.rotation.x += 0.005;
    ball3.rotation.y += 0.005;
    
    ball3.position.x = Math.sin(Date.now() / 1100) * 9;
    ball3.position.y = Math.sin(Date.now() / 6100) * 5;
    ball3.position.z = Math.sin(Date.now() / 2100) * 2;

    //ball4
    ball4.rotation.x += 0.002;
    ball4.rotation.y += 0.002;
    
    ball4.position.x = Math.sin(Date.now() / 1100) * -1;
    ball4.position.y = Math.sin(Date.now() / 6100) * -5;
    ball4.position.z = Math.sin(Date.now() / 2100) * -2;

    //ball5
    ball5.rotation.x += 0.002;
    ball5.rotation.y += 0.002;
    
    ball5.position.x = Math.sin(Date.now() / 1100) * 1;
    ball5.position.y = Math.sin(Date.now() / 6100) * -5;
    ball5.position.z = Math.sin(Date.now() / 2100) * 2;
    ...
    ball6.position.z = Math.sin(Date.now() / 2100) * 10;

    //ball7
    ball7.rotation.x += 0.000;
    ball7.rotation.y += 0.000;
    ball7.rotation.z += 0.002;
    
    ball7.position.x = Math.sin(Date.now() / 1100) * 12;
    ball7.position.y = Math.sin(Date.now() / 6100) * 5;
    ball7.position.z = Math.sin(Date.now() / 2100) * 7;
    ...
    ball8.position.x = Math.sin(Date.now() / 1100) * 3;
    ball8.position.y = Math.sin(Date.now() / 6100) * -6;
    ball8.position.z = Math.sin(Date.now() / 2100) * 3;
    ...
    ball9.position.x = Math.sin(Date.now() / 1100) * -7;
    ball9.position.y = Math.sin(Date.now() / 6100) * 7;
    ball9.position.z = Math.sin(Date.now() / 2100) * -7;
